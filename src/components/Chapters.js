...
// TOdo: In this Buttons are not placed in correct positioning
// import React, { useState, useEffect } from 'react';
// import { Link } from 'react-router-dom';
// import Krihnabg from '../pages/krishnabg.png';
// import icon from './Icon.svg';
...
//           const chunks = text.match(/.{1,150}/g) || [text]; // Decreased chunk size to 50 characters
...
//         <button type="button" className='w-[12rem] btn btn-primary' onClick={() => handleSpeech(`${Data.meaning.en} ${Data.summary.en}`, 'en')}>
//           {isSpeakingEn ? 'Stop Reading English' : 'Read Aloud English'}
//         </button>
//         <button type="button" className='w-[12rem] btn btn-primary' onClick={() => handleSpeech(`${Data.meaning.hi} ${Data.summary.hi}`, 'hi')}>
...
// Todo: In this we placing the buttons under the respective paragraph
// import React, { useState, useEffect } from 'react';
// import { Link } from 'react-router-dom';
// import Krihnabg from '../pages/krishnabg.png';
// import icon from './Icon.svg';
...
// Todo: Best Change in this section
// import React, { useState, useEffect } from 'react';
// import { Link } from 'react-router-dom';
// import Krihnabg from '../pages/krishnabg.png';
// import icon from './Icon.svg';
...
//       {/* Also addition of that section - Volume Buttons are not fix in this*/}
