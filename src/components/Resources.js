...
const books = [
    {
        ...
        image: Bhagvat_Gita,
        buyLink: 'https://www.amazon.in/Bhagavad-Gita-Hindi-C-Bhaktivedanta/dp/9382176330',
    ...
    },
    {
        name: 'The Ramayana',
        image: Ramayana,
        buyLink: 'https://www.amazon.in/Valmiki-Ramayana-Bhakti-Vikasa-Swami/dp/9382109137',
        readLink: 'https://ia801300.us.archive.org/9/items/HindiBookValmikiRamayanPartIByGitaPress/Hindi%20Book-Valmiki-Ramayan-Part-I%20by%20Gita%20Press.pdf'
    ...
    },
    {
        ...
        readLink: 'https://archive.org/details/mahabharata-by-gita-press-in-hindi-and-sanskrit/Mahabharata%20Volume%201/'
    },
    {
        name: 'The Holy Vedas',
        image: Holy_Veda,
        buyLink: 'https://www.amazon.in/Vedas-Edited-Pandit-Satyakam-Vidyalankar/dp/8185120544',
        readLink: 'https://archive.org/details/in.ernet.dli.2015.68948/page/n1/mode/2up'
    },
    {
        name: 'Dharmayoddha Kalki',
        image: Kalki,
        buyLink: 'https://www.amazon.in/Dharmayoddha-Kalki-Avatar-Vishnu-Book/dp/8193503309?source=ps-sl-shoppingads-lpcontext&ref_=fplfs&psc=1&smid=A1WYWER0W24N8S',
        readLink: 'https://archive.org/details/dharmayoddha-kalki-avatar-of-vishnu-by-kevin-missal-book-drive.com'
    },
    {
        name: 'The Upanishads',
        image: Upanishads,
        buyLink: 'https://www.amazon.in/Upanishads-Translated-Commentated-Swami-Paramananda/dp/9389717329',
        readLink: 'https://archive.org/details/lDtf_108-upanishad-gyan-khand-with-hindi-explanation-by-ram-sharma-acharya-yug-nirman-yojana-vistar-/page/n3/mode/2up'
    },
    {
        name: 'The Vishnu Puranas',
        image: VishnuPuranas,
        buyLink: 'https://www.exoticindiaart.com/book/details/vishnu-mahapuranam-azf640/',
        readLink: 'https://archive.org/details/vishnu-puran-gita-press/mode/2up'
    },
    {
        name: 'The Puranas',
        image: Puranas,
        buyLink: 'https://www.amazon.in/Puranas-Goddesses-Sunita-Pant-Bansal/dp/9391914977',
        readLink: 'https://archive.org/details/ThePuranas'
    },
    {
        name: 'The ShivaPurana',
        image: ShivaPurana,
        buyLink: 'https://www.exoticindiaart.com/book/details/siva-purana-complete-set-in-4-volumes-nab424/',
        readLink: 'https://vedpuran.net/wp-content/uploads/2011/10/shiv-puran.pdf'
    },
    {
        name: 'The AgniPurana',
        image: AgniPurana,
        buyLink: 'https://www.amazon.in/Agni-Purana-Ancient-Tradition-Mythology/dp/8120803590',
    ...
    },
    {
        name: 'Vedangas',
        image: Vedangas,
        buyLink: 'https://www.exoticindiaart.com/book/details/history-of-vedangas-haa693/',
        readLink: 'https://archive.org/details/VedangaJyotisha/mode/2up'
    },
    {
        name: 'The Brahmanas',
        image: Brahmanas,
        buyLink: 'https://www.exoticindiaart.com/book/details/sri-aitareya-brahmana-in-set-of-2-volumes-idj474/',
        readLink: 'https://archive.org/details/ShatpathBrahmanHindiVigyanBhashyaDwitiyaKhandaMotilalShastri/page/n1/mode/2up'
    },
    {
        name: 'MatsyaPuran',
        image: MatsyaPuran,
        buyLink: 'https://www.amazon.in/Complete-Matsya-Puran-Translation-Gorakhpur/dp/B097KB6JL6',
        readLink: 'https://vedpuran.net/wp-content/uploads/2011/10/matsya-puran-1.pdf'
    },
];
    ...
    return (
        <div className="flex flex-wrap justify-center items-center p-5">
            {books.map((book, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg m-4 w-72 h-[600px] sm:h-[530px] overflow-hidden transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl">
                    ...
                    <div className="p-6 text-center">
                        ...
                        {(book.name === 'The Bhagavad Gita' || book.name === 'Dharmayoddha Kalki' || book.name === 'The Puranas' || book.name === 'Vedangas') && (
                            <p className="text-gray-600">Discover the deep insights and timeless wisdom of the {book.name}.</p>
                        )}
                        {(book.name === 'The Ramayana' || book.name === 'The Brahmanas' || book.name === 'The AgniPurana') && (
                            <p className="text-gray-600">Explore the profound insights and ancient wisdom contained in the {book.name}.</p>
                        )}
                        {(book.name === 'The Mahabharata' || book.name === 'GarudaPuran' || book.name === 'The ShivaPurana') && (
                            <p className="text-gray-600">Immerse yourself in the profound knowledge and timeless teachings of the {book.name}.</p>
                        )}
                        {(book.name === 'The Holy Vedas' || book.name === 'The Upanishads' || book.name === 'MatsyaPuran') && (
